...
void main() {
  ...
  final flutterOutputPath =
      'packages/marionette_flutter/lib/src/version.g.dart';
...
''';
  ...
  for (final path in [outputPath, flutterOutputPath]) {
    final file = File(path);
    // Ensure the directory exists
    file.parent.createSync(recursive: true);
    file.writeAsStringSync(generatedContent);
    print('Generated $path with version: $version');
  }
}
